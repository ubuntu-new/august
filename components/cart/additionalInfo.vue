                ...
                <v-stepper alt-labels non-linear v-model="e1">
                    <v-stepper-header>
                        ...
                        <v-stepper-step editable :complete="e1 > 2" step="2" class="stepTwo">
                            {{$t('cartItems.аdditionalInfo')}}
                        </v-stepper-step>

                        <v-divider></v-divider>

                        <v-stepper-step editable step="3" class="stepThree">
                             {{$t('cartItems.checkout')}}
                        </v-stepper-step>
                    </v-stepper-header>
                                ...
                                <div class="col-sm-12">
                                    <div class="checkoutLeftInner backgroundGray">
                                        <div class="billing-details">
                                            <h3 class="title">{{$t('cartItems.аdditionalInfo')}}</h3>
                                            <v-divider></v-divider>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group">
                                                        <label>{{$t('cartItems.district')}} </label>
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <label>{{$t('cartItems.address')}} <span class="required">*</span></label>
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <div class="form-group">
                                                        <label>{{$t('cartItems.city')}} <span class="required">*</span></label>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>{{$t('cartItems.email')}} <span class="required">*</span></label>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        <label>{{$t('cartItems.phone')}} <span class="required">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="btn btn-checkout" @click="changeStep(3, null)">{{$t('cartItems.proceed')}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="checkoutRightInner ">
                                        <div class="cart-table table-responsive">
                                            <h3 class="title">{{$t('cartItems.product')}}</h3>
                                            <v-divider></v-divider>
