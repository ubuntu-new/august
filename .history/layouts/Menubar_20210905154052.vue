        ...
        <div class="comero-nav">
            ...
            <div class="container mobiluriza" style="position: relative;">
                <div class="col-12 top h-100px">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        <i class="fas fa-grip-lines" target="navbarSupportedContent"></i>



                        <b-navbar-toggle ></b-navbar-toggle>

                        <b-collapse class="collapse navbar-collapse webertelaModal" id="navbarSupportedContent" is-nav>
                            <ul class="navbar-nav">
