<template>
<div class="დეს">
    <section class="desktopiza">
        <div class="container" style="margin-top:90px;">
            <div class="row">
                <div class="col-lg-5 mb-70 blog-content">
                    <h1 class="blogTitle">
                        <nuxt-link to="/blog-one" class="blogTitle">{{$t('cartItems.blog')}}</nuxt-link>
                    </h1>
                </div>
            </div>
            <div class="row" v-for="featured in featuredNews" :key="featured.id">
                <div class="col-lg-5">
                    <img :src="`http://localhost/webertela-new/backend/web/images/store/${featured.filePath}`" />
                    <!-- <img :src="`http://august.webertela.online/backend/web/images/store/${featured.filePath}`" /> -->
                </div>
                <div class="col-lg-7">
                    <div class="mt-60">
                        <p class="futured">{{$t('cartItems.feautured')}}</p>
                        <h1 class="blogTitle">{{ featured.title }}</h1>
                        <p class="text" v-html="featured.description"></p>
                        <ul class="list-inline justify-content-center">
                            ...
                            <li class="list-inline-item">
                                <router-link class="maxLink" :to="{ name: 'blog-details', params: { news: featured }}">
                                    {{$t('cartItems.exploreMore')}}Explore more
                                </router-link>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="news-area ptb-60 desktopiza">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6" v-for="news in allNews" :key="news.id">
                    <div class="single-news-post">
                        <div class="news-image">
                            ...
                            <img :src="`http://localhost/webertela-new/backend/web/images/store/${news.filePath}`" />
                            <!-- </nuxt-link> -->
                        </div>
    ...
    <section class="mobiluriza news-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 blog-content">
                    <h1 class="blogTitle">
    ...
    <section class="news-area mobiluriza">
        <div class="container">
            <div class="row">
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "http://localhost/webertela-new/rest/web/index.php?r=v1/news/list",
