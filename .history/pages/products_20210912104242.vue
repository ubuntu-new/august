...
<div class="products">
    ...
    <div class="page-title-area desktopiza">
...
export default {
    ...
    mounted() {
        ...
        axios.request({
            ...
            "http://localhost/webertela-new/rest/web/index.php?r=v1/categories/list",
            headers: {
        ...
        .then((response) => {
            ...
            if (lang == 'ka') {
                    ...
                    console.log('Catogeries Response: ', response);
                    this.allCategories = response.data;
                    this.featuredNews = this.allCategories.filter((x) => x.feautured == '1');
                    console.log('Categories: ', this.featuredNews);
                }
        });
