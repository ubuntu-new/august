        ...
        <div class="AboutMain desktopiza">
            ...
            <div class="row">
                ...
                <div class="sashualo border-right border-top h-500 relative">
                    <img src="img/about/about-first.jpg" class="one img-fluid absolute">
                </div>
                <div class="sashualo border-right border-top h-500">
                    <img src="img/about/about-second.jpg" class="two img-fluid absolute">
                </div>
                <div class="didi border-right border-top">
                    <div class="my-auto text-left aboutiza">
