...
<section class="cart-area  backgroundWhite ">
    <div class="container desktopiza">
        <form>
            <div class="row ">
                <div class="col-lg-9 col-sm-12 cartItemsLeftInner backgroundGray">
                            ...
                            <tbody v-if="cart.length > 0">
                                ...
                                <tr v-for="(cart, i) in cart" :key="i">
                                    ...
                                    <td class="product-comment">
                                        <div class="input-counter">
                                            <br>
                                            <textarea v-model="message[i]" v-bind:placeholder="$t('cartItems.writeComment')"></textarea>
                                        </div>
                                    </td>
    ...
    <div class="container mobiluriza">
        <form>
            <div class="row backgroundGray">
                <div class="col-sm-12 cartItemsLeftInner ">
            ...
            <div class="row checkoutRightInner">
