                ...
                <slide v-for="slide in allSlides" :key="slide.id">
                    <router-link :to="{ name: 'products', params: { catId: slide.catId }}">
                        <div class="banner-section item-left">
                            ...
                            <img :src="`http://localhost/webertela-new/backend/web/images/store/${slide.filePath}`" class="banner-image-right" />
                        </div>
                    </router-link>
                </slide>
            </carousel>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
            ...
            "http://localhost/webertela-new/rest/web/index.php?r=v1/slider/list",
            headers: {
